...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Plot CCI indicator')
    ...
    cci_plot = mpf.make_addplot(cci_values, panel=1, color='blue', width=1.5)

    mpf.plot(
        df,
        type='candle',
        style='charles',
        title=f'{ticker} {granularity_name} chart with CCI',
        ylabel='Price',
        addplot=[cci_plot],
        panel_ratios=(3, 1),
    )
